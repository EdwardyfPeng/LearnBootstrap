#' @title Bootstrap Sampling from Several Populations(varying error variance)
#' @description
#' This is a function that can help you do bootstrap test of several populations using F statistics under varying error variance.
#'
...
bootstrap_F_test_unequal <- function(data_list, n_bootstrap = 5000) {
  ...
  for (i in 1:n_bootstrap) {
    ...
    bootstrap_errors <- lapply(errors, function(e) sample(e, length(e), replace = TRUE))
